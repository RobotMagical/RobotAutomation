...
parser.add_argument('-env', metavar="ENVIRONMENT", help='Supported ENVIRONMENT values : MAJOR,PREPROD(default)',
                    default="PREPROD",choices=['MAJOR', 'PREPROD'])
...
if exitcode == 252:
    ...
    print("\nPlease provide correct RobotFile fullname or prefix*. For example: TC001* will invoke TC001__consumer_activation_powerplan.robot ")
